...
function display() {
  ...
  for (let i = 0; i < weatherList.length; i++) {
    ...
    let minTemp = weatherList[i].day.mintemp_c;
      ...
      <div class="col-md-4 toda text-centery" id="thisDay">
        <div class="card todaycard p-4" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <i class="fa-solid fa-umbrella-beach" style="color: #B197FC;"></i>
            <span>${humidity}</span>
            <i class="fa-solid fa-wind" style="color: #B197FC;"></i>
            <span>${windSpeed}km/h</span>
            <i class="fa-regular fa-compass" style="color: #B197FC;"></i>
            <span>${windDir}</span>
          </div>
        </div>
      </div>
